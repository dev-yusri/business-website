...
<title>InggitMalaysia | Popular</title>
    ...
    <div class="page-header_wrap">
      <div class="page-heading">
        <div class="flex items-center justify-center mb-10" style="float:left">
          <div style="flex: 1">
          <img src="assets/images/icons8-facebook-like-100 (1).png" class="w-56 h-56" alt="Map marker icon"></div>
          <div><h2 style="font-size:36px; margin-left:10px">POPULAR</h2></div>
</div>
      </div>
    </div>
  </div>
