...
<title>InggitMalaysia | Near Me</title>
    ...
    <div class="page-header_wrap">
      <div class="page-heading">
        <div class="flex items-center justify-center mb-10" style="float:left">
          ...
          <div><h2 style="font-size:36px; margin-left:10px">NEAR ME</h2></div>
</div>
      </div>
    </div>
  </div>
...
<section class="listing-page" style="min-height:1000px">
  ...
  <div class="flex items-center justify-center mb-10" style="float:left">
  <div style="flex: 1">
  <h1 class="text-5xl font-bold">Offer Near:</h1>
</div>
...
<div class="ml-5">         <form action="nearme.php" method="post" id="header-search-form">
            <input class="italic text-gray-500 text-4xl" id="search-button" type="text" value="<?php echo htmlentities($result->City);?>" name="searchdata" class="form-control" required id="search-input">
...
$sql = "SELECT tblvoucher.VoucherTitle,tbltype.VoucherType,tblvoucher.Discount,tblvoucher.Tagline,tblstore.NameStore,tblvoucher.id,tblvoucher.Vimage1,tblvoucher.voucherEnd,tblvoucher.storeCity,tblvoucher.storeState,tblvoucher.VoucherType,tblvoucher.TermsC from tblvoucher 
...
WHERE tblvoucher.voucherEnd >= CURDATE() 
        AND (tblvoucher.storeCity LIKE :search OR tblvoucher.storeState LIKE :search)";
$query = $dbh -> prepare($sql);
...
<table>
  <thead>
    <tr>
      <th style="width:40%"><form method="post" action="">
      <a href="#terms_<?php echo $result->id; ?>"  data-toggle="modal" data-dismiss="modal">
<div class=""><img src="admin/img/voucherimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive w-2/3" alt="image">
</div>
</th>
<th>
<div class="">
<h2 class="text-gray-500 font-bold font-6xl mb-2"><?php echo htmlentities($result->VoucherType);?></h2>
<h2 class="text-blue-500 font-semibold font-4xl mb-2"><a href="store-details.php?sname=<?php echo htmlentities($result->NameStore); ?>"><?php echo htmlentities($result->NameStore);?></a></h2>
<h2 class="text-black font-bold font-6xl"><?php echo htmlentities($result->VoucherTitle);?></h2>
<h2 class="text-black font-medium font-4xl">Up to <?php echo htmlentities($result->Discount);?> %!</h2>
<h2 class="text-black font-medium font-4xl"><?php echo htmlentities($result->Tagline);?></h2>
</a>
...
<?php }
            ...
            echo '<br><br><h3 class="text-4xl font-semibold">&nbsp; &nbsp; &nbsp; Not found...</h3><br><br>';
          }
