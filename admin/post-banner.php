...
$sql="INSERT INTO tblbanner(bName,Bimage1) VALUES(:bname,:bimage1)";
...
<label class="col-sm-2 control-label">Banner Title</span></label>
<div class="col-sm-8">
...
<h4><b>Upload Banner Image</b></h4>
</div>
<div class="col-sm-2">
Max file size: 5mb<span style="color:red">*</span>
<div class="form-group">
<div class="col-sm-4">
<input id="inp" type="file" accept="image/*" name="bimage1" required></div>
</div>
</div>
