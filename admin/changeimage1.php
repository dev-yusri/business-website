...
$sql="update tblstore set promoImg=:promoimg where id=:id";
$query = $dbh->prepare($sql);
$query->bindParam(':promoimg',$vimage1,PDO::PARAM_STR);
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT promoImg from tblstore where tblstore.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
