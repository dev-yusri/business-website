...
$sql="update tblstore set logoStore=:logostore where id=:id";
$query = $dbh->prepare($sql);
$query->bindParam(':logostore',$vimage1,PDO::PARAM_STR);
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Store Image</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Store Image Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT logoStore from tblstore where tblstore.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-default" action="action" onclick="window.history.go(-1)" type="submit"  value="Cancel">Back</button>
												</div>
											</div>
